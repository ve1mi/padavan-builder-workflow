...
sed -i 's/CONFIG_RT2880_FLASH_16M=y/# CONFIG_RT2880_FLASH_16M is not set/g' padavan-ng/trunk/configs/boards/ASUS/RT-N14U/kernel-3.4.x.config
sed -i 's/^# CONFIG_RT2880_FLASH_8M is not set$/CONFIG_RT2880_FLASH_8M=y/g' padavan-ng/trunk/configs/boards/ASUS/RT-N14U/kernel-3.4.x.config
...
# Использование '!' в качестве разделителя вместо '/'

sed -i 's!../../pt_ralink_16m.config!pt_ralink_8m.config!g' padavan-ng/trunk/configs/boards/ASUS/RT-N14U/partitions.config
