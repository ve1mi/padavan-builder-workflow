...
cp https://github.com/prostovelikij/padavan-builder-workflow/blob/main/my-kernel.config padavan-ng/trunk/configs/boards/ASUS/RT-N14U/kernel-3.4.x.config
